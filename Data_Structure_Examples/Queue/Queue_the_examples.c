...
void Work_with_queue(){
    ...
    Instruction data = {data:"Store 0001",instruction:1,address:address1};
    Node node1 = {data:data};
    Node* pnode1 = &node1;
    queue.Enqueue(&queue,&node1);

    Instruction data2 = {data:"Store 0010",instruction:1,address:address1};
    Node node2 = {data:data2};
    Node* pnode2 = &node2;
    queue.Enqueue(&queue,&node2);

    Instruction data3 = {data:"Store 0011",instruction:1,address:address1};
    Node node3 = {data:data3};
    Node* pnode3 = &node3;
    queue.Enqueue(&queue,&node3);

    Instruction data4 = {data:"Store 1101",instruction:1,address:address1};
